...
double foobar(double t, uint64_t iters) {
  ...
  typedef controlled_runge_kutta<runge_kutta_dopri5<
      state_type, typename state_type::value_type, state_type, double>>
      stepper_type;
  // typedef euler< state_type , typename state_type::value_type , state_type ,
  // double > stepper_type;
